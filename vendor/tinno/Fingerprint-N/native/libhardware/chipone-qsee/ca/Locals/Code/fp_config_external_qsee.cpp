...
const gesture_config_t gesture_config =
{
...
#define FAE_VERSION_SUB  0x01
#define FAE_CUSTOMER_ID  0x0a
#define FAE_PRODUCT_ID   0x02
...
//----------------------------fp_config----------------------------------------------------
        ...
        {FP_CONFIG_FORBIDDEN_DUPLICATED_FINGER_ENROLL,                  1},         //(0,1) if do not want to enroll same finger, enable this feature
        ...
        {FP_CONFIG_FEATURE_AUTH_FIRST_ENTER_NO_WAIT_UP,                 0},         //(0,1) on first time enter authenticate funcation, do not wait finger up
        ...
        {FP_CONFIG_FEATURE_AUTH_RETRY_ADDITIONAL_2S,                    0},         //(0,1) after auth failed and report unmatch msg, allow to retry additional 2s, configurable when FP_CONFIG_FEATURE_AUTH_UNMATCH_RETRY = 1
...
#define FINGERPRINT_HAL_NAME  "fingerprint.chipone"
