...
#define FINGERPRINT_HARDWARE_MODULE_ID "fingerprint.silead"
...
typedef enum fingerprint_acquired_info {
    ...
    //add by tinno begin
    FINGERPRINT_ACQUIRED_VENDOR_DUPLICATE_FINGER = 6, /* checked same finger when enroll*/
    FINGERPRINT_ACQUIRED_VENDOR_DUPLICATE_AREA = 7, /* checked same area when enroll*/
    //add by tinno end
    FINGERPRINT_ACQUIRED_VENDOR_BASE = 1000, /* vendor-specific acquisition messages start here */
    // Added by sileadinc begin
    // if ALI-YunOS 'FINGERPRINT_ACQUIRED_VENDOR_BASE' need modified to 1100;
    // This expand msg type follow ALI-YunOS
    FINGERPRINT_ACQUIRED_VENDOR_FINGER_DOWN = FINGERPRINT_ACQUIRED_VENDOR_BASE + 2,
    FINGERPRINT_ACQUIRED_VENDOR_FINGER_UP = FINGERPRINT_ACQUIRED_VENDOR_BASE + 3,
    //FINGERPRINT_ACQUIRED_VENDOR_DUPLICATE_FINGER = FINGERPRINT_ACQUIRED_VENDOR_BASE + 5, /* checked same finger when enroll*/
    //FINGERPRINT_ACQUIRED_VENDOR_DUPLICATE_AREA = FINGERPRINT_ACQUIRED_VENDOR_BASE + 6 /* checked same area when enroll*/
    // Added by sileadinc end
