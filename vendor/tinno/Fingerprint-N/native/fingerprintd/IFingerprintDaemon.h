...
class IFingerprintDaemon : public IInterface, public IBinder::DeathRecipient {
    public:
        enum {
           ...
           SET_MSG = IBinder::FIRST_CALL_TRANSACTION + 12, //guomingyi add start.
           GET = IBinder::FIRST_CALL_TRANSACTION + 13, //guomingyi add start.
        };
        ...
        //guomingyi add start.
        virtual void setMsg(int32_t msg) = 0;
        virtual int get(int32_t arg) = 0;
        //guomingyi add end
