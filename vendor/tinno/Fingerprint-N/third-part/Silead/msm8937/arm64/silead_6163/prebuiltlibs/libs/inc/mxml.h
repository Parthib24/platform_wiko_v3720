 ...
 * Prototypes...
 */
extern void		mxmlSetLoneWhitespaceOff(int isOff);
...
extern mxml_node_t	*mxmlLoadFile(mxml_node_t *top, void *fp,
			              mxml_type_t (*cb)(mxml_node_t *));
...
extern int		mxmlSaveFd(mxml_node_t *node, int fd,
			           mxml_save_cb_t cb);
extern int		mxmlSaveFile(mxml_node_t *node, void *fp,
			             mxml_save_cb_t cb);
...
extern mxml_node_t	*mxmlSAXLoadFile(mxml_node_t *top, void *fp,
			                 mxml_type_t (*cb)(mxml_node_t *),
			                 mxml_sax_cb_t sax, void *sax_data);
