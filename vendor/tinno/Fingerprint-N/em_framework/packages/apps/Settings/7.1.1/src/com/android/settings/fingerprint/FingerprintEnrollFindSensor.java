...
public class FingerprintEnrollFindSensor extends FingerprintEnrollBase {
    ...
    private ImageView mSensorLocationImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSensorLocationImage = (ImageView)findViewById(R.id.fingerprint_sensor_location);
        mText = (TextView)findViewById(R.id.find_sensor_message_textview);
        
        if(mText != null && mSensorLocationImage != null && FingerprintFeatureOptions.isBackFingerprint()) {
            mText.setText(R.string.zzz_security_settings_fingerprint_enroll_find_back_sensor_message);
            mSensorLocationImage.setImageResource(R.drawable.fingerprint_sensor_location_back);
        }
    ...
    protected int getContentView() {
        ...
        if (isMyosUi){
            return R.layout.myos_fingerprint_enroll_find_sensor_base;
        }
        //TINNO END
    ...
    private void launchConfirmLock() {
	 ...
	 Log.d(TAG, "launchConfirmLock challenge = " + challenge);	
