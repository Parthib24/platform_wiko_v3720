...
public class FingerprintSettings extends SubSettings {
    ...
    public static final boolean isMenuInSecurity = true;
    ...
    public static class FingerprintSettingsFragment extends SettingsPreferenceFragment
        ...
        private final String KEY_ENROLL_STATE = "enroll_state";
        private boolean mFingerprintEnrolling;
        private boolean mPreventQuit;
        ...
        public void onCreate(Bundle savedInstanceState) {
	      ...
	      Log.i(TAG, "onCreate:");
            if (savedInstanceState != null) {
                ...
                mFingerprintEnrolling = savedInstanceState.getBoolean(KEY_ENROLL_STATE,false);
            }
	...
	/*
           ...
           //TinnoFingerprint[guomingyi] add start.
            ...
            myHandler.postDelayed(mVerifyRunnable = new Runnable() {
                ...
                public void run() {
                    if(getActivity() == null){ Log.i(TAG, "getActivity:null!"); return; }
                    boolean b = ApeCustomFpManager.isDeviceLocked(getActivity());
                    Log.i(TAG, "onResume:isDeviceLocked:"+b + " | mVerifyTag:"+mVerifyTag);
                    if(!b){
                        retryFingerprint();
                    } else if (mVerifyTag < MAX_RETRY_TIMES) {
                        mVerifyTag ++;
                        removeVerifyRunnable();
       ...
       private void removeVerifyRunnable(){
        ...
        private boolean needFinishActivity(){
            return mToken !=null && !mPreventQuit && !mFingerprintEnrolling && !getActivity().isFinishing();
        }
        ...
        public void onConfigurationChanged(Configuration newConfig) {
            ...
            mPreventQuit = oldOrientation != newConfig.orientation;
        }
        ...
        public void onSaveInstanceState(final Bundle outState) {
            ...
            outState.putBoolean(KEY_ENROLL_STATE,mFingerprintEnrolling);
        }
        ...
        private void launchChooseOrConfirmLock() {
	     ...
	     Log.d("cts_fp", "launchConfirmLock challenge = " + challenge);		
