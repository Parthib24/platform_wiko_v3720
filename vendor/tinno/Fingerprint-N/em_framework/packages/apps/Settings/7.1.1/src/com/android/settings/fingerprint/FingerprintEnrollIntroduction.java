...
public class FingerprintEnrollIntroduction extends FingerprintEnrollBase
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isMyosUi){
            setContentView(R.layout.myos_fingerprint_enroll_introduction);
        }else {
    ...
    protected void onNextButtonClick() {
        ...
        if (getFingerprintCountCheck()) {
            Toast t= Toast.makeText(FingerprintEnrollIntroduction.this, R.string.fingerprint_enroll_full, Toast.LENGTH_SHORT);
            t.show();
            return ;
        }
        // TINNO END
    ...
    // TINNO BEGIN
    // add for fingerprint support.
    private boolean getFingerprintCountCheck(){
        ...
        return fingerprintCount < 5 ? false : true ;
    }
    // TINNO END
