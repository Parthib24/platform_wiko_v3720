...
//TINNO BEGIN
//<Disable home and menu key only in front fingerprint enrolling page><Modified by yinglong.tang>20170314
...
public class FingerprintEnrollEnrolling extends FingerprintEnrollBase
    ...
    private PhoneStateListener listener = new PhoneStateListener(){ 
        ...
        public void onCallStateChanged(int state, String incomingNumber) { 
            ...
            case TelephonyManager.CALL_STATE_RINGING: 
                 ...
                 //CallCancelEnroll();
                  Toast t = Toast.makeText(FingerprintEnrollEnrolling.this, R.string.call_status_enroll_fingerprint, Toast.LENGTH_SHORT);
                  t.show();
                  finish();
                break; 
            } 
    ...
    public void onResume() {
        ...
        //TINNO BEGIN
        //<Disable home and menu key only in front fingerprint enrolling page><Modified by yinglong.tang>20170314
        if (!FingerprintFeatureOptions.isBackFingerprint()) {
    ...
    public void onPause() {
        ...
        super.onPause();
        tm.listen(listener, PhoneStateListener.LISTEN_NONE);
        Log.d("FingerprintEnrollEnrolling", "onPause()");
        if (mSidecar != null) {
            mSidecar.setListener(null);
        }
        stopIconAnimation();
    ...
    protected void onStop() {
        ...
        if (!FingerprintFeatureOptions.isBackFingerprint()) {
            if (mStatusBarManager != null) {
                ...
                Log.d(TAG, "mStatusBarManager disable err!");
            }
        }
        //TINNO END
    ...
    public void onEnrollmentHelp(CharSequence helpString) {
        ...
        if(EmFrameworkStatic.isTnFpSupport/*Features.is_em2*/){
            Log.d(TAG, "FingerprintEnrollEnrolling onEnrollmentHelp | helpString = " + helpString);       
