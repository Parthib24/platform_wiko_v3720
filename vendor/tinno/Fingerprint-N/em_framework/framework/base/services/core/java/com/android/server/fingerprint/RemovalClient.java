...
public abstract class RemovalClient extends ClientMonitor {
    ...
    private static final String TAG = "RemovalClient-cls";
    ...
    public boolean onRemoved(int fingerId, int groupId) {
        if (fingerId != 0) {
	     ...
	     //TINNO BEGIN, added by wenguangyu, for fingerprint
            ApeFpDataUtils.getInstance().removeApeFpDataForUser(getContext(), fingerId,
                    getTargetUserId());	     
